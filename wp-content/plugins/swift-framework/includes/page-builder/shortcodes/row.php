<?php
    ...
    */
    ...
    $params[] = array(
        "type"        => "uislider",
        "heading"     => __( "Padding - Vertical (depreciated)", 'swift-framework-plugin' ),
        "param_name"  => "row_padding_vertical",
        "value"       => "0",
        "description" => __( "Adjust the vertical padding for the row. (px). This is a depreciated option, please see the Design tab for current controls.", 'swift-framework-plugin' )
    );

    if ( sf_theme_supports('advanced-row-styling') ) {
        $params[] = array(
            "type"        => "uislider",
            "heading"     => __( "Padding - Horizontal (depreciated)", 'swift-framework-plugin' ),
            "param_name"  => "row_padding_horizontal",
            "value"       => "0",
            "min"         => "0",
            "step"        => "1",
            "max"         => "20",
            "description" => __( "Adjust the horizontal padding for the row. (%). This is a depreciated option, please see the Design tab for current controls.", 'swift-framework-plugin' )
        );
    }

    $params[] = array(
        "type"        => "uislider",
        "heading"     => __( "Margin - Vertical (depreciated)", 'swift-framework-plugin' ),
        "param_name"  => "row_margin_vertical",
        "value"       => "0",
        "description" => __( "Adjust the margin above and below the row. (px). This is a depreciated option, please see the Design tab for current controls.", 'swift-framework-plugin' )
    );
    $params[] = array(
        "type"        => "buttonset",
    ...
    $params[] = array(
        "type"        => "buttonset",
        "heading"     => __( "Vertically Center Elements", 'swift-framework-plugin' ),
